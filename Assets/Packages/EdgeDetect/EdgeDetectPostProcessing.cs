...
public class EdgeDetectPostProcessing : PostProcessEffectSettings
{
	...
	[Range(0f, 1f)] public FloatParameter t = new FloatParameter() { value = 1.0f };
	...
	public ColorParameter bgColor = new ColorParameter() { value = Color.white };
}
...
public class EdgeDetectPostProcessingRenderer<T> : PostProcessEffectRenderer<T> where T : EdgeDetectPostProcessing
{
	...
	public override void Render(PostProcessRenderContext context)
	{
		...
		sheet.properties.SetFloat("_T", Mathf.Clamp01(settings.t));
		...
		sheet.properties.SetVector("_EdgeColor", settings.edgeColor.value);
		sheet.properties.SetVector("_BgColor", settings.bgColor.value);
