...
public class EdgeDetectPostProcessing_Editor<T> : PostProcessEffectEditor<T> where T : EdgeDetectPostProcessing
{
	...
	SerializedParameterOverride bgColor;

	GUIContent gc_mode = new GUIContent("Mode");
	GUIContent gc_t = new GUIContent(" T");
	...
	GUIContent gc_edgeColor = new GUIContent(" Edge Color");
	GUIContent gc_bgColor = new GUIContent(" Bg Color");
	...
	public override void OnEnable()
	{
		...
		bgColor = FindParameterOverride(x => x.bgColor);
	}
	...
	public override void OnInspectorGUI()
	{
		...
		PropertyField(edgeColor, gc_edgeColor);
		PropertyField(bgColor, gc_bgColor);
	}
}